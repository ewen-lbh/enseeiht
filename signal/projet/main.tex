...
\]
Voici la DSP expérimentale:

\begin{figure}[H]
	\centering
\input{figures/dsp-nrz-aleatoire-experimentale.tex}
\end{figure}
...
\begin{figure}[H]
	\centering
	\input{figures/filtrage-signal-module.tex}
...
\subsubsection{Image mystère}


On peut désormais utiliser cette méthode de démodulation pour démoduler les images proposées. On divise les coefficients de la matrice par 255 et on assemble le puzzle pour obtenir l'image suivante:

\begin{center}
	\includegraphics[width=0.5\textwidth]{camichel.png}
\end{center}
...
C'est une photo de l'ancien Foy' de l'ENSEEIHT, situé très précisément aux coordonnées {\bf 43°36'06.7"N 1°27'18.3"E}
