...
begin
    ...
    Afficher_Deux_Positions (2); -- ERREUR: cette fonction est privée
    New_Line;
    ...
    Une_Date.jour := 15; -- T_Date est en private, l'affectation à un membre du record est désactivée
    Une_Date.Mois := Mois_Suivant; -- T_Date est en private, l'affectation à un membre du record est désactivée
    Afficher (Une_Date);
    New_Line;

    -- Illustrer les opérations possibles sur T_Date, type privé
    Autre_Date := Une_Date; -- T_Dates est en limited private, l'affectation est désactivée
    Put ("Autre date : ");
    Afficher (Autre_Date);
    New_Line;
