...
-- Les éléments sont stockés par ordre d'indice croissant, ce qui facilite le calcul du produit scalaire, de l'égalité et de la somme:
-- on peut itérer sur les éléments et effectuer les opérations élément par élément.
