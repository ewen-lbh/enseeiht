...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#bf8f0a40#;
   ...
   u00140 : constant Version_32 := 16#80cadc0d#;
   pragma Export (C, u00140, "cache_abrB");
   u00141 : constant Version_32 := 16#699a68e3#;
   pragma Export (C, u00141, "cache_abrS");
   u00142 : constant Version_32 := 16#2977d08d#;
   pragma Export (C, u00142, "ada__strings__boundedB");
   u00143 : constant Version_32 := 16#ec9a5f73#;
   pragma Export (C, u00143, "ada__strings__boundedS");
   u00144 : constant Version_32 := 16#ccf19e02#;
   pragma Export (C, u00144, "ada__strings__superboundedB");
   u00145 : constant Version_32 := 16#6859258e#;
   pragma Export (C, u00145, "ada__strings__superboundedS");
   u00146 : constant Version_32 := 16#0de7ae30#;
   pragma Export (C, u00146, "ada__strings__fixedB");
   u00147 : constant Version_32 := 16#64881af1#;
   pragma Export (C, u00147, "ada__strings__fixedS");
   u00148 : constant Version_32 := 16#fe8205ec#;
   pragma Export (C, u00148, "ada__text_io__unbounded_ioS");
   u00149 : constant Version_32 := 16#013bf30d#;
   pragma Export (C, u00149, "ada__strings__unbounded__text_ioB");
   u00150 : constant Version_32 := 16#8b1e6ee0#;
   pragma Export (C, u00150, "ada__strings__unbounded__text_ioS");
   ...
   u00156 : constant Version_32 := 16#a07a41cd#;
   ...
   u00159 : constant Version_32 := 16#c80f8806#;
   pragma Export (C, u00159, "system__img_fixed_32S");
   u00160 : constant Version_32 := 16#3a3869b5#;
   pragma Export (C, u00160, "system__arith_32B");
   u00161 : constant Version_32 := 16#22ba3ee4#;
   pragma Export (C, u00161, "system__arith_32S");
   u00162 : constant Version_32 := 16#1968212b#;
   pragma Export (C, u00162, "system__exn_intS");
   u00163 : constant Version_32 := 16#2549028f#;
   pragma Export (C, u00163, "system__img_utilB");
   u00164 : constant Version_32 := 16#c9a0e932#;
   pragma Export (C, u00164, "system__img_utilS");
   u00165 : constant Version_32 := 16#98c6c945#;
   ...
   u00174 : constant Version_32 := 16#458a70a7#;
   pragma Export (C, u00174, "cachesB");
   u00175 : constant Version_32 := 16#8ed668d5#;
   pragma Export (C, u00175, "cachesS");
   ...
   u00180 : constant Version_32 := 16#e9046dda#;
   ...
   u00183 : constant Version_32 := 16#e42d37a4#;
   pragma Export (C, u00183, "system__powten_fltS");
   u00184 : constant Version_32 := 16#442857a6#;
   pragma Export (C, u00184, "system__img_lfltS");
   u00185 : constant Version_32 := 16#3ba468d8#;
   pragma Export (C, u00185, "system__img_lluS");
   u00186 : constant Version_32 := 16#86c10e50#;
   pragma Export (C, u00186, "system__powten_lfltS");
   u00187 : constant Version_32 := 16#99025045#;
   pragma Export (C, u00187, "system__img_llfS");
   u00188 : constant Version_32 := 16#3bda5e83#;
   pragma Export (C, u00188, "system__powten_llfS");
   u00189 : constant Version_32 := 16#95ce9f6e#;
   pragma Export (C, u00189, "system__val_fltS");
   u00190 : constant Version_32 := 16#07cab9e4#;
   pragma Export (C, u00190, "system__exn_fltS");
   u00191 : constant Version_32 := 16#89342272#;
   pragma Export (C, u00191, "system__val_lfltS");
   u00192 : constant Version_32 := 16#b98b583d#;
   pragma Export (C, u00192, "system__exn_lfltS");
   u00193 : constant Version_32 := 16#5331daad#;
   pragma Export (C, u00193, "system__val_llfS");
   u00194 : constant Version_32 := 16#9425984d#;
   ...
   u00196 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00196, "ada__integer_text_ioS");
   u00197 : constant Version_32 := 16#ba001e29#;
   pragma Export (C, u00197, "system__img_biuS");
   u00198 : constant Version_32 := 16#f75ed9f7#;
   pragma Export (C, u00198, "system__img_llbS");
   u00199 : constant Version_32 := 16#80af2c85#;
   pragma Export (C, u00199, "system__img_lllbS");
   u00200 : constant Version_32 := 16#f316ccbd#;
   pragma Export (C, u00200, "system__img_llliS");
   u00201 : constant Version_32 := 16#8adb3589#;
   pragma Export (C, u00201, "system__img_lllwS");
   u00202 : constant Version_32 := 16#ab6cacfc#;
   pragma Export (C, u00202, "system__img_llwS");
   u00203 : constant Version_32 := 16#85daa51b#;
   pragma Export (C, u00203, "system__img_wiuS");
   u00204 : constant Version_32 := 16#236b2bc2#;
   pragma Export (C, u00204, "system__val_intS");
   u00205 : constant Version_32 := 16#28959a26#;
   pragma Export (C, u00205, "system__val_unsS");
   ...
   u00211 : constant Version_32 := 16#fba7f029#;
   pragma Export (C, u00211, "system__memoryS");
   u00212 : constant Version_32 := 16#594a9fda#;
   pragma Export (C, u00212, "tableB");
   u00213 : constant Version_32 := 16#451f2158#;
   pragma Export (C, u00213, "tableS");
   u00214 : constant Version_32 := 16#460ff4d9#;
   pragma Export (C, u00214, "lcaB");
   u00215 : constant Version_32 := 16#1f5c0e5d#;
   pragma Export (C, u00215, "lcaS");
   u00216 : constant Version_32 := 16#7edeba2f#;
   pragma Export (C, u00216, "exceptionsS");
   u00217 : constant Version_32 := 16#a5d5f90d#;
   pragma Export (C, u00217, "system__exp_unsS");
   u00218 : constant Version_32 := 16#39e065b2#;
   pragma Export (C, u00218, "operateur_routeur_laB");
   u00219 : constant Version_32 := 16#8e805be1#;
   pragma Export (C, u00219, "operateur_routeur_laS");
   u00220 : constant Version_32 := 16#391d07a6#;
   pragma Export (C, u00220, "ada__directoriesB");
   u00221 : constant Version_32 := 16#6e6aef73#;
   pragma Export (C, u00221, "ada__directoriesS");
   u00222 : constant Version_32 := 16#dbe78fbc#;
   pragma Export (C, u00222, "ada__calendarB");
   u00223 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00223, "ada__calendarS");
   u00224 : constant Version_32 := 16#51f2d040#;
   pragma Export (C, u00224, "system__os_primitivesB");
   u00225 : constant Version_32 := 16#a527f3eb#;
   pragma Export (C, u00225, "system__os_primitivesS");
   u00226 : constant Version_32 := 16#4f95b496#;
   pragma Export (C, u00226, "ada__directories__hierarchical_file_namesB");
   u00227 : constant Version_32 := 16#752941c9#;
   pragma Export (C, u00227, "ada__directories__hierarchical_file_namesS");
   u00228 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00228, "ada__directories__validityB");
   u00229 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00229, "ada__directories__validityS");
   u00230 : constant Version_32 := 16#6ed11461#;
   pragma Export (C, u00230, "system__file_attributesS");
   u00231 : constant Version_32 := 16#98c06228#;
   pragma Export (C, u00231, "system__os_constantsS");
   u00232 : constant Version_32 := 16#b9a3a304#;
   pragma Export (C, u00232, "system__regexpB");
   u00233 : constant Version_32 := 16#81e831d1#;
   pragma Export (C, u00233, "system__regexpS");
   u00234 : constant Version_32 := 16#5236be49#;
   pragma Export (C, u00234, "parsingB");
   u00235 : constant Version_32 := 16#0aebb6d2#;
   pragma Export (C, u00235, "parsingS");
   u00236 : constant Version_32 := 16#665f8d0d#;
   pragma Export (C, u00236, "routeursimpleB");
   u00237 : constant Version_32 := 16#0eed6e71#;
   pragma Export (C, u00237, "routeursimpleS");
   u00238 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00238, "system__concat_4B");
   u00239 : constant Version_32 := 16#dcbebd3d#;
   ...
   --  routeursimple%s
   --  routeursimple%b
   --  operateur_routeur_la%s
   --  operateur_routeur_la%b
   --  routeur_la%b
