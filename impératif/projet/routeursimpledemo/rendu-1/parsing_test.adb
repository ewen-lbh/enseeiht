...
procedure parsing_test is
    ...
    procedure Test_analyse_fichier_paquets
    ...
    begin
        ...
        Assert_Equal
           (To_String (contenu_resultats),
            To_String (contenu_effectif_resultats));
        ...
        Close (fichier_resultats);
    end Test_analyse_fichier_paquets;

    procedure Test_parse_command_line
...
begin
    ...
    Test_analyse_fichier_paquets
       (contenu_table     =>
           To_Unbounded_String
              ("147.127.16.0 255.255.240.0 eth0" & NL &
               "147.127.18.0 255.255.255.0 eth1" & NL &
               "147.127.0.0 255.255.255.0 eth2" & NL &
               "212.0.0.0 255.0.0.0 eth3" & NL & "0.0.0.0 0.0.0.0 eth0" & NL),
        contenu_paquets   =>
           To_Unbounded_String
              ("212.212.212.212" & NL & "147.127.18.80" & NL &
               "147.127.18.85" & NL & "table" & NL & "147.127.19.1" & NL &
               "147.127.20.20" & NL & "147.127.32.32" & NL & "fin" & NL &
               "187.525.1.1" & NL),
        contenu_resultats =>
           To_Unbounded_String
              ("212.212.212.212 eth3" & NL & "147.127.18.80 eth1" & NL &
               "147.127.18.85 eth1" & NL & "147.127.19.1 eth0" & NL &
               "147.127.20.20 eth0" & NL & "147.127.32.32 eth0" & NL));
    Put_Line ("Test_analyse_fichier_paquets OK");
end parsing_test;
